...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-center pt-6 pb-12 px-6 min-h-[calc(100vh-11rem)]">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="w-full max-w-sm bg-card-dark rounded-[2.5rem] border border-white/5 p-10 shadow-2xl relative overflow-hidden"
            >
                ...
                <div className="text-center space-y-5 mb-10">
                    <div className="w-16 h-16 bg-accent-cyan/10 rounded-3xl flex items-center justify-center mx-auto ring-1 ring-accent-cyan/20">
                        <ShieldCheck className="w-8 h-8 text-accent-cyan" />
                    </div>
                    <div className="space-y-2">
                        <h1 className="text-3xl font-black tracking-tight">Access Roomie</h1>
                ...
                <div className="space-y-6 flex flex-col items-center">
                    ...
                    <div className="text-center space-y-3 bg-white/5 p-5 rounded-3xl border border-white/5">
